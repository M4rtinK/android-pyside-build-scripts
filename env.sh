...
export ARCH="armeabi"
export CFLAGS="-DANDROID -mandroid -fomit-frame-pointer -pipe "
...
export LDFLAGS="--sysroot ${ANDROID_NDK}/platforms/android-${ANDROID_PLATFORM_NUMBER}/arch-arm ${PYTHON_LIBS} -nostdlib -shared -Wno-strict-aliasing -Wl,-O1 -Wl,-z,noexecstack -Wl,-shared,-Bsymbolic -Wl,--no-whole-archive -L${QT_DIR}/lib -lQtCore -lpython2.7 -lstdc++ -lsupc++ -lgcc -llog -lz -lm -ldl -lc"
